...
import { Briefcase, Search, CheckCircle, Scale, Headphones } from "lucide-react";
  ...
  const approaches = [
    {
      ...
      description: "We understand the complexities of construction and energy and provide solutions tailored to your business"
    },
    {
    ...
    },
    {
      ...
      description: "Whether you need temporary staff for a project or permanent hires for long-term growth, we've got you covered"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            the unique needs of the construction and energy sectors.
          </p>
        </div>
