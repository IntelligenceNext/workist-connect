    ...
    <div className="relative min-h-[600px] pt-[15vh] pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-white max-w-3xl mx-auto mb-12 leading-relaxed backdrop-blur-sm bg-black/20 p-6 rounded-xl">
          Case studies provide real-world examples of how businesses have successfully 
          implemented strategies and solutions to overcome challenges and achieve their goals. 
          At Workist For IT, we collaborate with over 100 top multinational companies (MNCs) 
          to bring you inspiring success stories that showcase the impact of effective 
          workforce solutions.
        </p>
