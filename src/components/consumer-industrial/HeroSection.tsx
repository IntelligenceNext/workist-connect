    ...
    <div className="relative min-h-[600px] pt-[15vh] pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
          Driving Innovation in Consumer and Industrial Sectors
        </h1>
        ...
        <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed">
          At Workist For IT, we understand the unique challenges and opportunities in the 
          consumer and industrial sectors. From manufacturing and supply chain optimization 
          to retail and consumer goods, we provide tailored staffing and workforce solutions 
