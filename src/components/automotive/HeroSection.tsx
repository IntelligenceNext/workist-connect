  ...
  return (
    <div className="relative min-h-[600px] pt-[15vh] pb-20 px-4 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1511919884226-fd3cad34687c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80")',
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed">
          The automotive industry is undergoing a transformative shift, driven by advancements 
          in technology, sustainability, and consumer demands. At Workist For IT, we provide 
          tailored workforce solutions that help automotive companies stay ahead of the curve.
        </p>
