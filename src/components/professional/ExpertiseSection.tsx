        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight">
              Deep Expertise With a Broad Approach
            </h2>
            ...
            <p className="text-lg text-[#8E9196] leading-relaxed mt-8">
              Our experts welcome any challenge. We have the bench strength, experience, 
              grit, and boots-on-the-ground know-how to tackle whatever your business needs.
            </p>
          </div>
