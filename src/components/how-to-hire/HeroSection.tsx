    ...
    <div className="relative min-h-[600px] pt-[15vh] pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed">
          Hiring the right talent is critical to the success of any organization. At Workist For IT, 
          we bring you proven strategies and insights to streamline your hiring process. With collaborations 
          with over 100 top multinational companies (MNCs), we provide expertise that helps you attract, 
          evaluate, and onboard top talent effectively.
        </p>
