  ...
  const approaches = [
    {
      ...
      description: "We understand the complexities of the public sector and provide solutions tailored to your agency"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-primary mb-6">
            Our Proven Approach to Government Staffing
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            At Workist For IT, we take a strategic and customized approach to 
