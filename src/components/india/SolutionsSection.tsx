  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1590845947670-c009801ffa74?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80")',
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {solutions.map((solution, index) => (
            <div 
              key={index} 
              className="group p-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="bg-[#FF9933]/10 p-3 rounded-lg w-fit mb-4 group-hover:bg-[#FF9933]/20 transition-colors">
                <div className="text-[#FF9933] animate-bounce">{solution.icon}</div>
              </div>
